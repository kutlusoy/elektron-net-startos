...
const dict = {
  // main.ts
  'The Elektron Net RPC Interface is ready': 1,
  'The Elektron Net RPC Interface is not ready': 2,
  'Blockchain Sync': 3,
  'Elektron Net is fully synced': 4,
  'Elektron Net is starting…': 5,
  'Syncing blocks...${percentage}%': 6,
  'RPC Proxy': 7,
  'The Elektron Net RPC Proxy is ready': 8,
  'The Elektron Net RPC Proxy is not ready': 9,
  'Sync Complete': 10,
  ...
  'Streams real-time Elektron Net block and transaction notifications (hashes and raw data)': 107,
  ...
  "The Transaction Index will be rebuilt once Elektron Net is started again, unless 'Coinstats Index' is disabled in the config settings. Please don't do this unless you fully understand what you are doing.": 802,
  ...
  "The Coinstats Index will be rebuilt once Elektron Net is started again, unless 'Transaction Index' is disabled in the config settings. Please don't do this unless you fully understand what you are doing.": 902,
  ...
  'Network and other runtime information about this Elektron Net node': 1101,
  'Node Runtime Info': 1102,
  Connections: 1103,
  'The number of peers connected (inbound and outbound)': 1104,
  'IPC Socket Path': 1105,
  'Unix socket path for IPC communication with Elektron Net. Other services can bind to this socket in their Docker configuration.': 1106,
  ...
  Connect: 1246,
  'Connect Nodes': 1247,
  'Add addresses of nodes for Elektron Net to EXCLUSIVELY connect to.': 1248,
  ...
  'Add Node': 1250,
  'Add Nodes': 1251,
  'Add addresses of nodes for Elektron Net to connect with in addition to default nodes.': 1252,
  'Blocks Only': 1258,
  ...
  'ZeroMQ Enabled': 1700,
  'The ZeroMQ interface is useful for some applications which might require data related to block and transaction events from Elektron Net. For example, LND requires ZeroMQ be enabled for LND to get the latest block data': 1701,
  'Transaction Index': 1702,
  'By enabling Transaction Index (txindex) Elektron Net will build a complete transaction index. This allows Elektron Net to access any transaction with commands like `getrawtransaction`.': 1703,
  ...
  'Requires Tor or I2P to be active. Elektron Net will refuse to start if neither is available.': 2004,
  'Database Batch': 1724,
  ...
  'Enable IPC': 1736,
  'Enable inter-process communication (IPC) via Unix socket. This allows other services to communicate with Elektron Net using a high-performance local socket connection. The socket path will be displayed in Runtime Information.': 1737,
